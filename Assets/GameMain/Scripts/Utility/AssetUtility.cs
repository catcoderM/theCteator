namespace StarForce
{
    public static class AssetUtility
    {
        ...
        {
            return string.Format("Assets/GameMain/Music/{0}", assetName);
        }
        ...
        public static string GetBiology(string assetName)
        {
            return string.Format("Assets/GameMain/UIForms/{0}.prefab", assetName);
        }
        ...
        public static string GetUIImageAssets(string assetName)
        {
            return string.Format("Assets/GameMain/Textures/transmission/{0}.png", assetName);
        }
